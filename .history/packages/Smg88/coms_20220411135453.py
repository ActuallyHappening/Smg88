...
class getYAMLConfig():
  def __init__(self, fileLocation=os.path.os.path.dirname(__file__)'C:\\Users\\verys\\OneDrive - Emmanuel College\\Coding\\GITHUB CLONED REPOSITORIES\\Smg88 v1\\Smg88\\packages\\Smg88\\coms.yaml') -> None:
