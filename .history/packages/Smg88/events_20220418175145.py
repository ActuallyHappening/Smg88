...
from Smg88.errors import ProgrammerError, ProgrammerErrorHandle, SafeCatchAll
import errors
...
class AutoEventStage(EventStage):
  ...
  Args:
      EventStage (_type_): _description_
  """
  heartbeat: EventStageHeartbeat = ...

  def __init__(self, *, nameHandle: str = ..., autobegin: bool = True, heartbeat: EventStageHeartbeat = ...) -> None:
