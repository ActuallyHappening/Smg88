...
class ProjectType(EnumParent):
    ...
    LocalToLocal = auto()
    LocalToRemote = auto()  # Local instance to access my remote stuff (basically client)
    # Local to control my remote stuff I am hosting locally
    LocalToLocallyRemote = auto()
    RemoteToRemote = auto()  # Random computer to access my remote stuff (website/discordbot)
