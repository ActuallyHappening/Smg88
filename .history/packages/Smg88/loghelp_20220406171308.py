...
**An actual description of logging levels are as follows:**
  ...
  # DEBUG = 9, this is not a sentinal value but is the original value of debug for the logging module
  ...
  # INFO = 19, this is not a sentinal value but is the original value of info for the logging module
  ...
  # WARNING = 29, this is not a sentinal value but is the original value of warning for the logging module
  ...
  # ERROR = 39, this is not a sentinal value but is the original value of error for the logging module
  ...
  # CRITICAL = 49, this is not a sentinal value but is the original value of critical for the logging module
  > STANDARD_CRITICAL = 53, this is the normal level of critical used by the bot and will typically describe internal events that are unrecoverably period. This is the level that should be used when the bot is unable to recover from the error, or when the bot is unable to continue functioning.
