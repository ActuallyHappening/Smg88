...
class ProjectType(EnumParent):
    ...
    Args:
        EnumParent (ProjectType): Type of network access (remote <-> locallyremote <-> remote)
    ...
    Long Description:
        ...
        Finally, consider the 'largest' side of an IOT (Internet of Things), the remote side. This is where anybody with internet connection can 
    """
    ...
    # Remote / Random instance to access my remote stuff (hosted website / discordbot)
    RemoteToRemote = auto()
    ...
    def _getProjects(filePath: str = FILE_PATH) -> dict:
        ...
        for dir in os.listdir(filePath):
            if os.path.isdir(os.path.join(filePath, dir)):
                ...
                projects[dir] = ProjectType.Project
        return projects
