...
class EventStage():
  ...
  Events are objects that have a channel and a name, as such to subscribe to a possible event you must put forward a function that decides if the event is what you want.
